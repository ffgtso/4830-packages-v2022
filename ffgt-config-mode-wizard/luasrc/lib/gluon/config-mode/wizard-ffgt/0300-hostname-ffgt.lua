return function(form, uci)
    ...
    hostname = hostname:gsub("^FFWDL%-", "")
    hostname = hostname:gsub("^FFGF%-", "")
    hostname = hostname:gsub("^FGH% ", "")
    hostname = hostname:gsub("^FGH%-", "")
    hostname = hostname:gsub("^fflip%-", "")
    hostname = hostname:gsub("^ff-lip%-", "")
    hostname = hostname:gsub("^ff-soest%-", "")
    hostname = hostname:gsub("^ff-moehne%-", "")
	...
	function o:write(data)
        ...
        newname = newname:gsub("^FFRW%-", "")
        newname = newname:gsub("^ffue%-", "")
        newname = newname:gsub("^FFUE%-", "")
        newname = newname:gsub("^ffce%-", "")
        newname = newname:gsub("^FFCE%-", "")
        newname = newname:gsub("^ffwdl%-", "")
        newname = newname:gsub("^FFWDL%-", "")
        newname = newname:gsub("^ffgf%-", "")
        newname = newname:gsub("^FFGF%-", "")
        newname = newname:gsub("^ffsueh%-", "")
        newname = newname:gsub("^FFSUEH%-", "")
        newname = newname:gsub("^fgh%-", "")
        newname = newname:gsub("^FGH%-", "")
        newname = newname:gsub("^fflip%-", "")
        newname = newname:gsub("^FFLIP%-", "")
        newname = newname:gsub("^ff-lip%-", "")
        newname = newname:gsub("^FF-LIP%-", "")
        newname = newname:gsub("^ff-soest%-", "")
        newname = newname:gsub("^FF-SOEST%-", "")
        newname = newname:gsub("^ff-moehne%-", "")
        newname = newname:gsub("^FF-MOEHNE%-", "")
        newname = newname:gsub("^ffbb%-", "")
        newname = newname:gsub("^FFBB%-", "")
